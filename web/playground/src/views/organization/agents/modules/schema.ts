...
/**
 * 基本信息表单配置
 * @param modeOptions - 服务模式选项（从代码配置 organization.agents.mode 获取）
 * @param patternOptions - 服务模式选项（从代码配置 organization.agents.pattern 获取）
...
export function useBasicInfoSchema(
  ...
  return [
    ...
    },
    {
      ...
      formItemClass: "col-span-2",
      controlClass: "w-full",
      label: $t("organization.agents.servicePattern"),
      rules: z.string().optional(),
    },
    {
      component: "Input",
