...
import { Form, FormItem, Select, Input, Button, Tag, Space, Tabs, TabPane } from "ant-design-vue";
        ...
        <Form layout="vertical">
          ...
          <FormItem label="连接状态">
            <Space>
              ...
              <Button
                :type="isInConnectionProcess ? 'default' : 'primary'"
                :loading="isConnecting"
                :danger="isInConnectionProcess"
          ...
          <FormItem label="通道">
            <Select
              ...
              placeholder="选择通道"
              allow-clear
              @change="(val: unknown) => updateConnectionConfig('channelId', (val as string) || '')"
            />
          </FormItem>
