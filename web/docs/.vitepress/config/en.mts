...
function sidebarGuide(): DefaultTheme.SidebarItem[] {
  return [
    ...
    },
    {
      text: 'Advanced',
      items: [
        { link: 'in-departmentsh/login', text: 'Login' },
        { link: 'in-departmentsh/theme', text: 'Theme' },
        { link: 'in-departmentsh/access', text: 'Access Control' },
        { link: 'in-departmentsh/locale', text: 'Internationalization' },
        { link: 'in-departmentsh/features', text: 'Common Features' },
        { link: 'in-departmentsh/check-updates', text: 'Check Updates' },
        { link: 'in-departmentsh/loading', text: 'Global Loading' },
        { link: 'in-departmentsh/ui-framework', text: 'UI Framework Switching' },
      ],
    },
    {
      text: 'Engineering',
